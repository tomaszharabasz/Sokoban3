...
/*	$.getScript("src/Level_7/isVariableLevel7.js", function(){
	...
	this.actionOnClick = function() {
		...
		isVariableReferenceLevel8(arr, score);
		_checkIfScore(arr,score);
		isVariableReference8(arr);  // tu juz nie ma warow
	...
	this.checkFor1 = function(arr) {
			_checkFor1.call(this, arr)
	}
	...
	function _searchSwitch() {
    	...
    	if (forStatement.exec(arr[0])) {
    		var checkForASD = _checkFor(arr);
    		alert("asd" + checkForASD[7] + checkForASD[6]);
    	}
