...
var Level31 = function (game){
	...
	this.actionOnClick = function() {	
			...
			for (var i=0;i<arr.length; i++) {
				if (ifScoreStatement.exec(arr[i])) {
...
Level31.prototype.create = function() {
		var o = new Level31();
...
Level31.prototype.update = function() {	
...
Level31.prototype.render = function() {	
